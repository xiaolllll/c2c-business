...
//    QUIT,                         // 退出
    ...
    SELLER_ALL_COMMODITY_INF,       //获取某个商家卖的所有商品
    SEND_COMMODITY,                 // 发货
    ...
    GET_ALL_COMMODITYS_SUCCESS,             // 获取某类所有商品成功
    GET_ALL_COMMODITYS_FAIL,                // 获取某类所有商品失败
    ...
    REMIND_BUYER_PAY_SUCCESS,                   //提醒对方发货
    REMIND_BUYER_PAY_FAIL                       //提醒对方发货
